...
export default function Dashboard() {
  ...
  useEffect(()=>{
      ...
      comCount = +json.recordset[0].progressCount
      inCount = +json.recordset[1].progressCount
      newCount = +json.recordset[2].progressCount
      susCount = +json.recordset[3].progressCount
